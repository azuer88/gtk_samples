...
class Label:
    ...
    def __init__(self):
        ...
        label = gtk.Label(
            "This is a line-wrapped label spread over multiple lines."
            "It supports multiple lines and correctly inserts many spaces   .")
        label.set_line_wrap(True)
        vbox_right.pack_start(label)

        label = gtk.Label(
            "This is a line-wrapped, filled label.  It takes the entire space "
            "allocated to it.\n\nIt also support multiple lines and correctly "
            "insertes many     spaces   .")
        label.set_line_wrap(True)
